...
-- Seed flashcards
-- CH7-fix (2026-06-07): the example_vi column was the SAME as example_en
-- for 13/14 cards (only card-biz-1 was correct). The bug was discovered
-- in the 2026-06-07 audit. Migration 004 had the correct UPDATE statements,
-- but fresh deployments that ran only 001-003 would have English in the
-- Vietnamese column. This commit fixes 003 to be correct standalone;
-- 004 remains as a safety net for already-broken deployments.
